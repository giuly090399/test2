...
class Player(BasePlayer):
    Registro = models.IntegerField(
        blank=True, label='¿Cuál es tu número de registro? (Este es el número que fue enviado a tu correo)'
    )
...
class InstGenerales(Page):
    pass


class Preguntas(Page):
    form_model = Player
    form_fields = ['Registro', 'Edad', 'Genero', 'Estado_Civil', 'Nivel_Educativo', 'Personas_dependientes', 'Habitantes', 'Ingreso', 'Fijo']


page_sequence = [InstGenerales, Preguntas]
